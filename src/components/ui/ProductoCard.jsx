    ...
    >
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <motion.a
          ...
          className="mt-auto w-full inline-flex items-center justify-center px-4 py-2 bg-[var(--color-aovet-primary)] text-white font-bold rounded-lg hover:bg-[var(--color-aovet-dark)] transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-aovet-primary)]"
