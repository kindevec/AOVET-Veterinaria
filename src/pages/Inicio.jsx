    ...
    <div className="flex flex-col min-h-screen bg-[var(--color-aovet-bg)] font-sans">
      ...
      <section className="py-6 sm:py-12 px-0 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden">
        ...
        >
          ...
          {/* PARTE 3: ASISTENCIA Y CONSEJOS UNIFICADOS (Contenedor Completo de Margen a Margen) */}
          <motion.div 
            initial="hidden" 
            whileInView="visible" 
            viewport={{ once: true }} 
          ...
          >
            ...
            >
              {/* Lado Izquierdo: Imagen Panorámica con Overlay y Badges Profesionales */}
              <div className="lg:w-[56%] relative min-h-[340px] sm:min-h-[420px] lg:min-h-[460px] overflow-hidden group flex flex-col justify-between p-6 sm:p-10">
                <img 
                  src={secFarmAction} 
              ...
              {/* Lado Derecho: Asesoría, Beneficios con Iconos, Botón y Crédito KINDEV */}
              <div className="lg:w-[44%] p-6 sm:p-8 md:p-10 flex flex-col justify-between bg-gradient-to-br from-white via-[#FAFBF8] to-[#F1F6EE] border-t lg:border-t-0 lg:border-l border-gray-100">
                ...
                {/* Botón de Acción y Crédito KINDEV */}
                <div className="pt-6 space-y-3.5">
                  ...
                  <div className="pt-2 flex items-center justify-between border-t border-gray-200/60 text-[11px] sm:text-xs text-gray-500">
                    <span className="font-medium text-gray-600">AOVET &bull; Salud Animal</span>
                    <span className="inline-flex items-center gap-1.5 font-bold text-[#2C382E]">
                      <span className="w-2 h-2 rounded-full bg-[var(--color-aovet-accent)] animate-pulse"></span>
                      Desarrollado por <span className="text-[var(--color-aovet-primary)] font-extrabold tracking-wide">KINDEV</span>
                    </span>
                  </div>
                </div>
              </div>
